...
class OmegaConfGrammarParser(Parser):
    ...
    def configValue(self):
        localctx = OmegaConfGrammarParser.ConfigValueContext(
    ...
    def singleElement(self):
        localctx = OmegaConfGrammarParser.SingleElementContext(
            self, self._ctx, self.state
        )
        ...
        def interpolation(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    OmegaConfGrammarParser.InterpolationContext, i
                )
    ...
    class ElementContext(ParserRuleContext):
        ...
        def quotedValue(self):
            return self.getTypedRuleContext(
                OmegaConfGrammarParser.QuotedValueContext, 0
            )

        def listContainer(self):
            return self.getTypedRuleContext(
                OmegaConfGrammarParser.ListContainerContext, 0
            )

        def dictContainer(self):
            return self.getTypedRuleContext(
                OmegaConfGrammarParser.DictContainerContext, 0
            )
    ...
    def listContainer(self):
        localctx = OmegaConfGrammarParser.ListContainerContext(
            self, self._ctx, self.state
        )
    ...
    class DictContainerContext(ParserRuleContext):
        ...
        def dictKeyValuePair(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    OmegaConfGrammarParser.DictKeyValuePairContext
                )
            else:
                return self.getTypedRuleContext(
                    OmegaConfGrammarParser.DictKeyValuePairContext, i
                )
    ...
    def dictContainer(self):
        localctx = OmegaConfGrammarParser.DictContainerContext(
            self, self._ctx, self.state
        )
    ...
    def dictKeyValuePair(self):
        localctx = OmegaConfGrammarParser.DictKeyValuePairContext(
            self, self._ctx, self.state
        )
    ...
    class SequenceContext(ParserRuleContext):
        ...
        def element(self, i: int = None):
            if i is None:
                ...
                return self.getTypedRuleContext(
                    OmegaConfGrammarParser.ElementContext, i
                )
    ...
    class InterpolationContext(ParserRuleContext):
        ...
        def interpolationNode(self):
            return self.getTypedRuleContext(
                OmegaConfGrammarParser.InterpolationNodeContext, 0
            )

        def interpolationResolver(self):
            return self.getTypedRuleContext(
                OmegaConfGrammarParser.InterpolationResolverContext, 0
            )
    ...
    def interpolation(self):
        localctx = OmegaConfGrammarParser.InterpolationContext(
            self, self._ctx, self.state
        )
    ...
    class InterpolationNodeContext(ParserRuleContext):
        ...
        def configKey(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(
                    OmegaConfGrammarParser.ConfigKeyContext
                )
            else:
                return self.getTypedRuleContext(
                    OmegaConfGrammarParser.ConfigKeyContext, i
                )
    ...
    def interpolationNode(self):
        localctx = OmegaConfGrammarParser.InterpolationNodeContext(
            self, self._ctx, self.state
        )
        ...
        try:
            ...
            _la = self._input.LA(1)
            while (
                _la == OmegaConfGrammarParser.BRACKET_OPEN
                or _la == OmegaConfGrammarParser.DOT
            ):
                self.state = 121
                self._errHandler.sync(self)
                token = self._input.LA(1)
    ...
    class InterpolationResolverContext(ParserRuleContext):
        ...
        def resolverName(self):
            return self.getTypedRuleContext(
                OmegaConfGrammarParser.ResolverNameContext, 0
            )
    ...
    def interpolationResolver(self):
        localctx = OmegaConfGrammarParser.InterpolationResolverContext(
            self, self._ctx, self.state
        )
    ...
    class ConfigKeyContext(ParserRuleContext):
        ...
        def interpolation(self):
            return self.getTypedRuleContext(
                OmegaConfGrammarParser.InterpolationContext, 0
            )
    ...
    def resolverName(self):
        localctx = OmegaConfGrammarParser.ResolverNameContext(
            self, self._ctx, self.state
        )
    ...
    def quotedValue(self):
        localctx = OmegaConfGrammarParser.QuotedValueContext(
            self, self._ctx, self.state
        )
