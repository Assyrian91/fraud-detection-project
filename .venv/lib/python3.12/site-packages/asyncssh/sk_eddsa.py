...
class _SKEd25519Key(SSHKey):
    ...
    def generate(
        ...
        *,  # type: ignore
        ...
        public_value, key_handle = sk_enroll(
            SSH_SK_ED25519, application, user, pin, resident
        )
    ...
    def make_private(cls, key_params: object) -> SSHKey:
        ...
        public_value, application, flags, key_handle, reserved = cast(
    ...
    def encode_ssh_public(self) -> bytes:
        ...
        return b"".join((String(self._key.public_value), String(self._application)))
    ...
    def sign_ssh(self, data: bytes, sig_algorithm: bytes) -> bytes:
        ...
        flags, counter, sig, _ = sk_sign(
            data, self._application, self._key_handle, self._flags
        )
    ...
    def verify_ssh(self, data: bytes, sig_algorithm: bytes, packet: SSHPacket) -> bool:
        ...
        return self._key.verify(
            self._app_hash + Byte(flags) + UInt32(counter) + sha256(data).digest(), sig
        )
