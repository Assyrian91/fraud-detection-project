...
class SSHServer:
    ...
    def validate_host_public_key(
        self, client_host: str, client_addr: str, client_port: int, key: SSHKey
    ) -> bool:
    ...
    def validate_host_based_user(
        self, username: str, client_host: str, client_username: str
    ) -> MaybeAwait[bool]:
    ...
    def unix_server_requested(self, listen_path: str) -> MaybeAwait[_NewUNIXListener]:
